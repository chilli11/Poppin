...
namespace Poppin.Services
{
	public class LogActionService : ILogActionService
	{
		...
		public void LogUserAction(string userId, string actionType) =>
			LogUserAction(userId, actionType, new Dictionary<string, string>());

		public async void LogUserAction(string userId, string actionType, IDictionary<string, string> logAction)
		{
